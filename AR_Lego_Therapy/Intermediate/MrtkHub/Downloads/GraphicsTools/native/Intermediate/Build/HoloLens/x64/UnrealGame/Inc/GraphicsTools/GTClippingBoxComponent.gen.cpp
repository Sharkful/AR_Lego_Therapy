...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UGTClippingBoxComponent);
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGTClippingBoxComponent_Statics::Class_MetaDataParams[] = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGTClippingBoxComponent_Statics::ClassParams = {
	...
	{
		if (!Z_Registration_Info_UClass_UGTClippingBoxComponent.OuterSingleton)
		{
			UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_UGTClippingBoxComponent.OuterSingleton, Z_Construct_UClass_UGTClippingBoxComponent_Statics::ClassParams);
		}
		return Z_Registration_Info_UClass_UGTClippingBoxComponent.OuterSingleton;
	}
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_GraphicsTools_Source_GraphicsTools_Public_GTClippingBoxComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GraphicsTools_Source_GraphicsTools_Public_GTClippingBoxComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGTClippingBoxComponent, UGTClippingBoxComponent::StaticClass, TEXT("UGTClippingBoxComponent"), &Z_Registration_Info_UClass_UGTClippingBoxComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGTClippingBoxComponent), 1407085852U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GraphicsTools_Source_GraphicsTools_Public_GTClippingBoxComponent_h_700123044(TEXT("/Script/GraphicsTools"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_GraphicsTools_Source_GraphicsTools_Public_GTClippingBoxComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_GraphicsTools_Source_GraphicsTools_Public_GTClippingBoxComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
